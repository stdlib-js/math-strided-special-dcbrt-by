...
* @returns accessed value
*/
type Ternary = ( value: any, idx: number, indices: Array<number> ) => number | void;
...
* @returns accessed value
*/
type Quaternary = ( value: any, idx: number, indices: Array<number>, arrays: Array<Float64Array> ) => number | void;
...
interface Routine {
	...
	*/
	( N: number, x: Float64Array, strideX: number, y: Float64Array, strideY: number, clbk: Callback, thisArg?: any ): Float64Array;
	...
	* // out => <Float64Array>[ 1.0, ~2.08, -3.0, ~4.327, -5.0 ]
	*/
	ndarray( N: number, x: Float64Array, strideX: number, offsetX: number, y: Float64Array, strideY: number, offsetY: number, clbk: Callback, thisArg?: any ): Float64Array;
}
